...
% NeurIPS-style report using report/neurips_2024.sty (with a safe fallback).

\documentclass{article}

% NeurIPS-style formatting (preferred).
% If the style file isn't present, fall back to a normal article layout.
...
\usepackage{hyperref}
\usepackage{url}
\usepackage{xurl} % allow long URLs to line-break cleanly
\hypersetup{
  breaklinks=true,
  pdftitle={Variational Autoencoders for Hybrid Music Clustering},
  pdfauthor={Mushfique Tajwar},
  pdfsubject={Neural Networks},
  pdfkeywords={variational autoencoder, VAE, beta-VAE, music clustering, hybrid music clustering, representation learning, unsupervised learning, deep learning, neural networks, latent space, K-Means, Agglomerative Clustering, DBSCAN, t-SNE, UMAP},
}
\urlstyle{same}
...
\end{document}% Variational Autoencoders for Hybrid Music Clustering
...
\IfFileExists{neurips_2024.sty}{%
  ...
  \usepackage[margin=1in]{geometry}%% Variational Autoencoders for Hybrid Music Clustering
% NeurIPS-style report (unofficial; uses neurips_2024 package).
...
\hypersetup{
  breaklinks=true,
  pdftitle={Variational Autoencoders for Hybrid Language Music Clustering},
  pdfauthor={Mushfique Tajwar},
  pdfsubject={Neural Networks},
  pdfkeywords={variational autoencoder, VAE, beta-VAE, music clustering, hybrid music clustering, representation learning, unsupervised learning, deep learning, neural networks, latent space, K-Means, Agglomerative Clustering, DBSCAN, t-SNE, UMAP},
}
...
\pgfplotstableset{%
  metrics-default/.style={%
	...
	\title{\textbf{Variational Autoencoders for Hybrid Language Music Clustering}}

% Draw horizontal rules above and below the title (to match the provided example).
\makeatletter
